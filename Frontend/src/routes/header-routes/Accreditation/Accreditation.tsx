...
export const Accreditation = () => {
	...
	const accreditationContent = (
		<div>
			...
			<strong className={'strong-style'}>Мета роботи відділу - </strong>
			<p>
				полягає у проведенні ряду заходів, пов'язаних із плануванням та
				організацією процесів ліцензування та акредитації різних напрямків
				підготовки (спеціальностей), за якими коледж здійснює підготовку
				фахівців.
			</p>
