	...
	const ElectromechanicalContent = (
		<div>
			...
			<Button
				onClick={() => {
					window.open(
						'https://www.youtube.com/watch?v=UAqbQnfXLBQ',
						'_blank'
					);
				}}
			>
				Презентація освітньої програми "Обслуговування верстатів з програмним управлінням і робототехнічних комплексів"
			</Button>
