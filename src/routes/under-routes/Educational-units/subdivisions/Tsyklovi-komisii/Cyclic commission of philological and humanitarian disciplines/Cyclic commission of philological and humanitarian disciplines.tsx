...
export const Cycliccommissionofphilologicalandhumanitariandisciplines = () => {
	const list = [
    {
	...
	const CycliccommissionofphilologicalandhumanitariandisciplinesContent = (
		<div>
   <Title text='Циклова комісія філологічних та гуманітарних дисциплін' />
        <hr className='hr-style' />
				<p>Методична проблема, над якою працює Циклова комісія в 2023-2024 н.р. – впровадження компетентнісного підходу в освітній процес підготовки за освітньо-професійним ступенем "фаховий молодший бакалавр" відповідно до вимог стандартів фахової передвищої освіти.</p><br />
				<p>Викладачі циклової комісії філологічних дисциплін здійснюють підготовку майбутніх спеціалістів з таких дисциплін:</p>
	...
	return (
		<Page title='Циклова комісія філологічних та гуманітарних дисциплін - ЧПФК'>
			<Block
				content={CycliccommissionofphilologicalandhumanitariandisciplinesContent}
			/>
		</Page>
	);
};
