...
export const CycCommDiscProfPracTrainElecEnergySpec = () => {
    const list = [
            {
	...
	const CycCommDiscProfPracTrainElecEnergySpecContent = (
		<div>
   <Title text='Циклова комісія дисциплін професійно-практичної підготовки електроенергетичних спеціальностей' />
       <p>Циклова комісія  дисциплін професійно – практичної підготовки електроенергетичних спеціальностей є випусковою  комісією фахових молодших бакалаврів, що навчаються за спеціальністю  141 « Електроенергетика, електротехніка та електромеханіка». Підготовка здійснюється за двома освітніми програмами: «Монтаж і експлуатація електроустаткування підприємств і цивільних споруд» та «Монтаж, експлуатація  та ремонт електротехнічних установок в агропромисловому комплексі».</p><br />
        <p>Викладачі циклової комісії мають глибокі теоретичні знання та значний практичний досвід роботи на підприємствах, що забезпечує належний рівень підготовки фахівців.</p>
        <p>Методична проблема над якою працює циклова комісія в 2023-2024 н.р. - впровадження компетентнісного підходу в освітній процес підготовки за освітньо-професійним ступенем "фаховий молодший бакалавр" відповідно до вимог стандартів фахової передвищої освіти. </p>  
	...
	return (
		<Page title='Циклова комісія дисциплін професійно-практичної підготовки електроенергетичних спеціальностей - ЧПФК'>
			<Block
				content={CycCommDiscProfPracTrainElecEnergySpecContent}
			/>
		</Page>
	);
};
