...
export const CyclicCommissionofDisciplinesofGeneralEducation = () => {
	const list = [
			{
	...
	const CyclicCommissionofDisciplinesofGeneralEducationContent = (
		<div>
   <Title text='Циклова комісія дисциплін загальноосвітньої підготовки' />
        <hr className='hr-style' />
       
        <p>Успішне розв’язання складних завдань навчання і виховання молоді вирішальною мірою залежить від учителя, його ідейної переконаності, професійної майстерності, ерудиції та культури.</p><br />
				<p>Циклова комісія в 2023-2024 н.р. працює над вирішенням методичної проблеми "Впровадження компетентнісного підходу в освітній процес підготовки за освітньо-професійним ступенем "фаховий молодший бакалавр" при викладанні загальноосвітніх дисциплін.</p><br />
	...
	return (
		<Page title='Циклова комісія дисциплін загальноосвітньої підготовки - ЧПФК'>
			<Block
				content={CyclicCommissionofDisciplinesofGeneralEducationContent}
			/>
		</Page>
	);
};
