...
export const CyclicalCommissionofRoadTransportDisciplines = () => {
	const list = [
			{
	...
	const CyclicalCommissionofRoadTransportDisciplinesContent = (
		<div>
   <Title text='Циклова комісія дисциплін автомобільного транспорту' />
	...
	return (
		<Page title='Циклова комісія дисциплін автомобільного транспорту - ЧПФК'>
			<Block
				content={CyclicalCommissionofRoadTransportDisciplinesContent}
			/>
		</Page>
	);
};
