...
export const CyclingCommissionofSoftwareandSocioEconomicDisciplines = () => {
    const list = [
        {
	...
	const CyclingCommissionofSoftwareandSocioEconomicDisciplinesContent = (
		<div>
   <Title text='Циклова комісія програмного забезпечення та соціально-економічних дисциплін' />
	...
	return (
		<Page title='Циклова комісія програмного забезпечення та соціально-економічних дисциплін - ЧПФК'>
			<Block
				content={CyclingCommissionofSoftwareandSocioEconomicDisciplinesContent}
			/>
		</Page>
	);
};
